                ...
                <div class="row">
                    ...
                    <div class="column">
                        ...
                        @if ($product->product_order == 'cancel')
                            <img src="{{ asset('assets/images/cancel.jpg') }}" style="margin-top: !important;" height="50px"
                                weight="50px" alt="">
                        ...
                        @if ($product->product_order == 'approve' || $product->product_order == 'delivery')
                            <img src="{{ asset('assets/images/right.png') }}" style="margin-top:-15px !important;"
                                height="50px" weight="50px" alt="">
                    ...
                    <div class="column">
                        ...
                        @if ($product->product_order == 'approve')
                            <h6 id="count_down" style="padding-top:25px;color:Red;padding-bottom:10px;">(Remaining :
                                {{ $product->delivery_time }})</h6>
                            <h1 style="color:Gray;padding-top:10px !important;" class="border2"></h1>
                            <input type="text" id="previous_time" style="display:none"
        ...
        <tfoot>
            ...
            <tr>
                <td colspan="5" class="text-right">
                    <a href="{{ url('/menu') }}" class="btn btn-warning"><i class="fa fa-angle-left"></i> Continue
                        Shopping</a>
