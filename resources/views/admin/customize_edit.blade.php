        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ asset('customize_edit_process') }}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" value="{{ $custo->title }}" class="form-control"
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlFile1">Section Image</label>
                            <input type="file" name="image" class="form-control-file" id="exampleFormControlFile1">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputName1">Youtube Video Link</label>
                            <input type="text" name="youtube_video_link" value="{{ $custo->youtube_link }}"
