...
@section('container')
    <a href="/add/coupon" type="button" class="btn btn-success" style="width:170px;height:35px;padding-top:9px;">+ Add
        Coupon</a>
                            ...
                            <tbody>
                                ...
                                @foreach ($coupons as $coupon)
                                    <tr>
                                        ...
                                        <td> {{ $coupon->couponProduct->validate }} </td>
                                        @if (Auth::user()->usertype == 1)
                                            <td>
                                                <a href="{{ asset('/admin/coupon/edit/' . $coupon->id) }}"
