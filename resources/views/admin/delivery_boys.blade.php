...
@section('container')
    <a href="/add/delivery_boy" type="button" class="btn btn-success" style="width:170px;height:35px;padding-top:9px;">+ Add
        Delivery boy</a>
                            ...
                            <tbody>
                                ...
                                @foreach ($delivery_boys as $delivery_boy)
                                    <tr>
                                        ...
                                        <td>{{ $delivery_boy->salary }} USD</td>



                                        <td>

                                            <a href="{{ asset('/delivery_boy/edit/' . $delivery_boy->id) }}"
                                                class="badge badge-outline-primary">Edit</a>
                                            <a href="{{ asset('/delivery_boy/delete/' . $delivery_boy->id) }}"
