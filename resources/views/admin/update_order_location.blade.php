                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td>Total </td>
                                <td class=""> USD {{ $wihout_discount_price }}</td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td>Discount </td>
                                <td class=""> USD {{ $discount_price }}</td>
                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample" action="{{ asset('/invoice/approve/' . $product->invoice_no) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" style="background-color:black !important;" name=""
                                    value="{{ $product->delivery_time }}" class="form-control" id="exampleInputName1"
                                    readonly>
                            ...
                            <div class="form-group">
                                ...
                                <input type="datetime-local" name="time" value="{{ $product->delivery_time }}"
