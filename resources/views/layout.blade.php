...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('clients/css/vendor.css') }}">
        ...
        <nav id="header-nav" class="navbar navbar-expand-lg px-3 mb-3">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ route('home') }}">
                    <img src="{{ asset('clients/images/main-logo.png') }}" class="logo">
                </a>
                        ...
                        <ul id="navbar"
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <a href="/my-order" class="dropdown-item">My Order</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-item">
                ...
                <div class="col-lg-4 col-xs-12">
                    <div class="right-text-content">
                        <ul class="social-icons">
                            <li><a href=https://www.facebook.com/truongvan.cuong2003/"><i
                                        class="fa fa-facebook"></i></a>
                            </li>
                            <li><a href="https://twitter.com/"><i class="fa fa-twitter"></i></a></li>
                            <li><a
                                    href="https://www.linkedin.com/in/c%C6%B0%E1%BB%9Dng-tr%C6%B0%C6%A1ng-v%C4%83n-24943626a/"><i
                                        class="fa fa-linkedin"></i></a></li>
                            <li><a href="https://www.instagram.com/tv_cuong03/"><i class="fa fa-instagram"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
