...
<div class="container">
                ...
                <tbody>
                    @foreach ($products as $product)
                        <tr style="border:2px solid;">
                            ...
                            <td style="margin-left:20px;">{{ $product->subtotal }} USD</td>
                        </tr>
                    @endforeach
                    ...
                    <tr>
                        ...
                        <td><strong>{{ $data['without_discount_price'] }} USD</strong></td>
                    </tr>
                    <tr>
                        <td colspan="4"></td>
                    </tr>
                    <tr>
                        ...
                        <td><strong>{{ $data['discount_price'] }} USD</strong></td>
                    </tr>
                    <tr>
                        <td colspan="4"></td>
                    </tr>
    ...
    <div class="row" style="margin-left:20px;">
        <div class="span3" style="font-size:16px;">
            <strong>MiniStore Admin</strong>
        </div>
        <br>
        <div class="span3">
            <strong>Phone:</strong>(+84) 886160515
        </div>
        <div class="span3">
            <strong>Email:</strong> <a href="truongvancuong.jvb@gmail.com">truongvancuong.jvb@gmail.com</a>
        </div>
